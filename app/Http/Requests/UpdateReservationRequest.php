...
class UpdateReservationRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        if ($reservation instanceof Reservation) {
            ...
            $res = Reservation::with('unit')->find($reservation);
            if ($res && ! $user->canEditSector($res->unit?->sector_id)) {
                return false;
            }
        }
    ...
    public function rules(): array
    {
        return [
            ...
            'extra_fees.*.id' => ['nullable', 'integer'],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            $reservationParam = $this->route('reservation');
            $reservationId = $reservationParam instanceof Reservation ? $reservationParam->id : (int) $reservationParam;
            ...
            $conflict = $availabilityService->findConflictingReservation($unitId, $checkIn, $checkOut, $reservationId);
